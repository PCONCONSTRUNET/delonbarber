...
const Agendar = () => {
  ...
  return (
    <div className="min-h-screen bg-background pb-24 overflow-x-hidden relative">
      ...
      {/* Navigation Buttons - fixos no bottom, fora do TabsContent */}
      {activeTab === 'agendar' && (
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="fixed bottom-0 left-0 right-0 z-50 p-3 sm:p-4 bg-background/90 backdrop-blur-lg border-t border-border safe-area-bottom"
        >
