  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <main className="relative z-10">
        ...
        <section className="min-h-[100dvh] flex flex-col items-center justify-center px-4 py-16 sm:py-20">
          ...
          <div className="relative mb-5 sm:mb-6">
            ...
            <div className="relative w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 rounded-full p-1 bg-gradient-to-br from-primary to-primary/50">
              <div className="w-full h-full rounded-full overflow-hidden border-3 sm:border-4 border-background">
                <img 
                  src={barberPhoto} 
          ...
          <div className="flex flex-col xs:flex-row items-center gap-3 xs:gap-6 mb-3 sm:mb-4">
            <a 
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-muted-foreground hover:text-green-500 transition-colors active:scale-95"
            >
          ...
          <h1 className="font-display text-4xl sm:text-5xl md:text-7xl font-bold text-center mb-3 sm:mb-4 tracking-tight">
            Barbearia
            <br />
          ...
          {/* Subtitle */}
          <p className="text-muted-foreground text-center text-base sm:text-lg md:text-xl max-w-md mb-8 sm:mb-10 px-2">
            Agende seu horário de forma rápida e exclusiva
          </p>

          {/* CTA Buttons - always stacked on mobile */}
          <div className="flex flex-col w-full max-w-xs sm:max-w-none sm:w-auto sm:flex-row gap-3 sm:gap-4">
            <Button 
              size="lg" 
              className="w-full sm:min-w-[180px] h-12 sm:h-11 text-base sm:text-lg font-semibold"
            ...
            <Button 
              variant="outline" 
              size="lg" 
              className="w-full sm:min-w-[180px] h-12 sm:h-11 text-base sm:text-lg border-foreground/20 hover:bg-foreground/5"
